...
#ifndef HTTPClientJPG_H_
#define HTTPClientJPG_H_

#ifndef HTTPClientJPG_1_1_COMPATIBLE
#define HTTPClientJPG_1_1_COMPATIBLE
#endif
...
#define HTTPClientJPG_DEFAULT_TCP_TIMEOUT (8000)

#define HTTPClientJPG_SENDBUFFER_SIZE 8192
...
public:
   ...
   * ensure the client object lives the entire time of the HTTPClientJPG
   */
...
protected:
  ...
  String _host;
  uint16_t _port = 0;
  int32_t _connectTimeout = HTTPClientJPG_DEFAULT_TCP_TIMEOUT;
  bool _reuse = true;
  uint16_t _tcpTimeout = HTTPClientJPG_DEFAULT_TCP_TIMEOUT;
  ...
  String _protocol;
  String _headers;
  String _userAgent = "ESP32HTTPClientJPG";
