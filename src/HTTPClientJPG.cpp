 ...
 * This file is part of the HTTPClientJPG for Arduino.
...
#ifdef HTTPClientJPG_1_1_COMPATIBLE
#include <WiFi.h>
...
#endif // HTTPClientJPG_1_1_COMPATIBLE

/**
 * constructor
 */
HTTPClientJPG::HTTPClientJPG() {
}
 ...
 * @return success bool
 */
bool HTTPClientJPG::begin(WiFiClient &client, String url) {
#ifdef HTTPClientJPG_1_1_COMPATIBLE
  if (_tcpDeprecated) {
 ...
 * @return success bool
 */
bool HTTPClientJPG::begin(WiFiClient &client, String host, uint16_t port, String uri, bool https) {
#ifdef HTTPClientJPG_1_1_COMPATIBLE
  if (_tcpDeprecated) {
    log_d("mix up of new and deprecated api");
    _canReuse = false;
...
#ifdef HTTPClientJPG_1_1_COMPATIBLE
bool HTTPClientJPG::begin(String url, const char *CAcert) {
 ...
 * @param url String
 */
bool HTTPClientJPG::begin(String url) {
  if (_client && !_tcpDeprecated) {
    log_d("mix up of new and deprecated api");
    _canReuse = false;
    end();
...
bool HTTPClientJPG::beginInternal(String url, const char *expectedProtocol) {
...
#ifdef HTTPClientJPG_1_1_COMPATIBLE
bool HTTPClientJPG::begin(String host, uint16_t port, String uri) {
  if (_client && !_tcpDeprecated) {
    log_d("mix up of new and deprecated api");
    _canReuse = false;
    end();
...
bool HTTPClientJPG::begin(String host, uint16_t port, String uri, const char *CAcert) {
  if (_client && !_tcpDeprecated) {
    log_d("mix up of new and deprecated api");
    _canReuse = false;
    end();
...
bool HTTPClientJPG::begin(String host, uint16_t port, String uri, const char *CAcert, const char *cli_cert, const char *cli_key) {
  if (_client && !_tcpDeprecated) {
    log_d("mix up of new and deprecated api");
    _canReuse = false;
    end();
 ...
 */
void HTTPClientJPG::disconnect(bool preserveClient) {
  if (connected()) {
 ...
 * @param reuse bool
 */
void HTTPClientJPG::setReuse(bool reuse) {
  _reuse = reuse;
}
 ...
 */
void HTTPClientJPG::setUserAgent(const String &userAgent) {
 ...
 */
void HTTPClientJPG::setAuthorization(const char *user, const char *password) {
  if (user && password) {
    String auth = user;
    auth += ":";
    auth += password;
 ...
 */
void HTTPClientJPG::setAuthorization(const char *auth) {
  if (auth) {
 ...
 */
void HTTPClientJPG::setAuthorizationType(const char *authType) {
  if (authType) {
 ...
 */
void HTTPClientJPG::setConnectTimeout(int32_t connectTimeout) {
 ...
 */
void HTTPClientJPG::setTimeout(uint16_t timeout) {
  _tcpTimeout = timeout;
  if (connected()) {
 ...
 * @param use
 */
void HTTPClientJPG::useHTTP10(bool useHTTP10) {
 ...
 * @return http code
 */
int HTTPClientJPG::POST(uint8_t *payload, size_t size) {
  return sendRequest("POST", payload, size);
}

int HTTPClientJPG::POST(String payload) {
 ...
 * @return http code
 */
int HTTPClientJPG::PATCH(uint8_t *payload, size_t size) {
  return sendRequest("PATCH", payload, size);
}

int HTTPClientJPG::PATCH(String payload) {
 ...
 * @return http code
 */
int HTTPClientJPG::PUT(uint8_t *payload, size_t size) {
  return sendRequest("PUT", payload, size);
}

int HTTPClientJPG::PUT(String payload) {
 ...
 * @return
 */
int HTTPClientJPG::sendRequest(const char *type, String payload) {
 ...
 */
int HTTPClientJPG::sendRequest(const char *type, uint8_t *payload, size_t size) {
  int code;
  bool redirect = false;
  ...
  do {
    ...
    if (payload && size > 0) {
      ...
      while (sent_bytes < size) {
        int c_index = 0;
        for (c_index = 0; c_index < size; c_index += HTTPClientJPG_SENDBUFFER_SIZE) {
          int left = size - c_index;
          if (left > HTTPClientJPG_SENDBUFFER_SIZE) {
            if (_client->write(&payload[sent_bytes], HTTPClientJPG_SENDBUFFER_SIZE) != HTTPClientJPG_SENDBUFFER_SIZE) {
              return returnError(HTTPC_ERROR_SEND_PAYLOAD_FAILED);
            }
            sent_bytes += HTTPClientJPG_SENDBUFFER_SIZE;
          } else {
            if (_client->write(&payload[sent_bytes], left) != left) {
              return returnError(HTTPC_ERROR_SEND_PAYLOAD_FAILED);
            }
            sent_bytes += left;
          }
      ...
      if (sent_bytes != size) {
        log_w("Error, total data sent is not original size");
        return returnError(HTTPC_ERROR_SEND_PAYLOAD_FAILED);
      }
    }
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HTTPClientJPG::sendRequest(const char *type, Stream *stream, size_t size) {
 ...
 * @return -1 if no info or > 0 when Content-Length is set by server
 */
int HTTPClientJPG::getSize(void) {
  return _size;
}
 ...
 * @return WiFiClient
 */
WiFiClient &HTTPClientJPG::getStream(void) {
  if (connected()) {
    return *_client;
  }
 ...
 * @return WiFiClient*
 */
WiFiClient *HTTPClientJPG::getStreamPtr(void) {
  if (connected()) {
    return _client;
  }
 ...
 */
int HTTPClientJPG::writeToStream(Stream *stream) {
 ...
 * @return String
 */
String HTTPClientJPG::getString(void) {
 ...
 * @return String
 */
String HTTPClientJPG::errorToString(int error) {
  switch (error) {
 ...
 * @param first
 */
void HTTPClientJPG::addHeader(const String &name, const String &value, bool first, bool replace) {
...
void HTTPClientJPG::collectHeaders(const char *headerKeys[], const size_t headerKeysCount) {
...
String HTTPClientJPG::header(const char *name) {
  for (size_t i = 0; i < _headerKeysCount; ++i) {
...
String HTTPClientJPG::header(size_t i) {
...
String HTTPClientJPG::headerName(size_t i) {
  if (i < _headerKeysCount) {
...
int HTTPClientJPG::headers() {
  return _headerKeysCount;
}

bool HTTPClientJPG::hasHeader(const char *name) {
  for (size_t i = 0; i < _headerKeysCount; ++i) {
 ...
 */
bool HTTPClientJPG::connect(void) {
  if (connected()) {
    if (_reuse) {
  ...
  if (!_client) {
    log_d("HTTPClientJPG::begin was not called or returned error");
    return false;
  }
#ifdef HTTPClientJPG_1_1_COMPATIBLE
 ...
 * @return status
 */
bool HTTPClientJPG::sendHeader(const char *type) {
  if (!connected()) {
    return false;
  }
 ...
 */
int HTTPClientJPG::handleHeaderResponse() {
 ...
 */
int HTTPClientJPG::writeToStreamDataBlock(Stream *stream, int size) {
  int buff_size = HTTP_TCP_BUFFER_SIZE;
  int len = size;
  int bytesWritten = 0;
 ...
 * @return error
 */
int HTTPClientJPG::returnError(int error) {
  if (error < 0) {
...
void HTTPClientJPG::setFollowRedirects(followRedirects_t follow) {
  _followRedirects = follow;
}

void HTTPClientJPG::setRedirectLimit(uint16_t limit) {
 ...
 * @param url
 */
bool HTTPClientJPG::setURL(const String &url) {
...
const String &HTTPClientJPG::getLocation(void) {
  return _location;
}

void HTTPClientJPG::setCookieJar(CookieJar *cookieJar) {
  _cookieJar = cookieJar;
}

void HTTPClientJPG::resetCookieJar() {
  _cookieJar = nullptr;
}

void HTTPClientJPG::clearAllCookies() {
  if (_cookieJar)
    _cookieJar->clear();
}

void HTTPClientJPG::setCookie(String date, String headerValue) {
  if (!_cookieJar) {
    return;
  }
...
bool HTTPClientJPG::generateCookieString(String *cookieString) {
  time_t now_local = time(NULL);
  time_t now_gmt = mktime(gmtime(&now_local));
